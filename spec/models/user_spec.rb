...
describe User do
  ...
  before do
    @user = User.new(name: "Example User", university: "University of Virginia", email: "user@example.com",
  ...
  describe "when password is not present" do
    before do
      @user = User.new(name: "Example User", university:"Example University" email: "user@example.com", type: "nurse recruiter"
